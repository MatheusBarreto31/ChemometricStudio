...
from runtime_paths import get_settings_dir
...
class SettingsManager:
    ...
    def __init__(self, settings_dir: Optional[Path] = None):
        ...
        Args:
            settings_dir: Directory to store settings.json. If None, uses a user-writable OS config dir.
        """
